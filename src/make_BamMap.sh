...
Evaluate success of GDC data download and print BamMap to STDOUT
...
BamMap format is TSV with the following columns:
    1  sample_name
    2  case
    3  disease
...
For every UUID, confirm existence of output file and (if appropriate) index
file.  All information used to generate BamMap comes from catalog file and
