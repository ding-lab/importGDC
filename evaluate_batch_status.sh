...
#CATALOG_TEST="dat/test.CATALOG.dat"

bash importGDC/evaluate_status.sh -O $DATA_ROOT -C $IMPORT_CONFIGD_H "$@" $CATALOG_H
#bash importGDC/evaluate_status.sh -O $DATA_ROOT -C $IMPORT_CONFIGD_H "$@" $CATALOG_TEST
