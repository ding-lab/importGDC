...
DC2 branch scripts for intialization and tracking of Batch 1 downloads on DC2 and other vanilla docker environments


## Preliminaries

Scripts here rely on [importGDC.git](/gscuser/mwyczalk/src/importGDC); this must be installed.
